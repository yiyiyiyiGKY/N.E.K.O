...
export default function ApiKeySettings() {
  ...
  return (
    <div className="api-key-settings-page">
      <div className="page-container">
        ...
        <div className="page-content">
          ...
          <section className="config-section">
            <h3>⚙️ 核心API配置</h3>
            <p className="hint">请确保API Key格式正确。保存后需要重启服务才能生效。</p>
            ...
            {advancedOpen && (
              <div className="advanced-content">
                <div className="info-box">
                  ...
                  <br />• 辅助API：负责记忆管理和自定义语音，只有阿里支持自定义语音
                </div>

                {/* Assist API Configuration */}
                <div className="form-group">
                  <label>辅助API（记忆管理/自定义语音/文本聊天）</label>
                  <select
                ...
                {Object.entries(config.assistApiKeys).map(([provider, key]) => (
                  <div key={provider} className="form-group">
                    <label>辅助API Key - {provider.toUpperCase()}</label>
                    <input
                      type="text"
                      value={key}
