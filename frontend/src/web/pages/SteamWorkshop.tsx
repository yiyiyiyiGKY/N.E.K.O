  ...
  return (
    <div className="neko-container">
      ...
      <div className="neko-header">
        <h2 data-text="Steam 创意工坊">Steam 创意工坊</h2>
      ...
      <div className="neko-content">
        ...
        <div className="tab-content">
          ...
          <div className="filter-controls">
            ...
            <button className="neko-btn neko-btn-primary" onClick={loadItems}>
              刷新订阅内容
            </button>
          </div>
              ...
              {filteredItems.map((item) => (
                <div key={item.id} className="item-card">
                  ...
                  <div className="item-actions">
                    {!item.downloaded && (
                      <button
                        className="neko-btn neko-btn-primary action-button"
                    ...
                    <button
                      className="neko-btn neko-btn-danger action-button"
